...
const RPC_URL = "https://avalanche-mainnet.infura.io/v3/0f0594731ab14200bc3e2dafdaa56d4a";

const WEMIX_CHAIN_SELECTOR = 5142893604156789321n;

const ContractAddress = {
    UniswapRouter: "0xbb00FF08d01D300023C629E8fFfFcb65A5a578cE",
    UniswapQuoter: "0xbe0F5544EC67e9B3b2D979aaA43f18Fd87E6257F",
    UnaBridge: "0xd3a0fa0991bc59fc682e7757223649196de4e0bc",
    UnaBridgeStorage: "0x6802db1ee426a6f509c2fc1e3c8e637f2bb347dc",
    WAVAX: "0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7",
    unaWEMIX: "0x9f1453d0fadc73ae12d4e1bd8311aa2463ae7d0d",
};
...
describe("Avalanche", function () {
    ...
    before(async () => {
        // const avalancheProvider = new ethers.JsonRpcProvider(RPC_URL);
        // const latestBlock = await avalancheProvider.getBlockNumber();
        await network.provider.send("hardhat_reset", [
            {
                forking: {
                    jsonRpcUrl: RPC_URL,
                    blockNumber: 43091021,
                },
            },
        ]);
        ...
        WAVAX = await ethers.getContractAt("ERC20", ContractAddress.WAVAX);
    ...
    describe("Swap", () => {
        it("Swap AVAX to unaWEMIX with Uni Swap", async () => {
            logger.log("Swap AVAX to unaWEMIX with Uni Swap");

            const avaxSendingQunatity = ethers.parseEther("1");

            const requestTicket: RequestTicket = {
                id: 1n,
                sender: user1.address,
                asset: ethers.ZeroAddress,
                quantity: avaxSendingQunatity,
                fee: 0n,
                funding: 0n,
            ...
            const approveTx = await mudskipper
                .connect(txRelayer)
                .approveMax(WAVAX.target, swapRouter.target, avaxSendingQunatity);
                ...
                swapData: [
                    {
                        ...
                        fromQuantity: avaxSendingQunatity,
    ...
    describe("Bridge", () => {
        it("Swap AVAX to unaWEMIX with Uni Swap And Bridge WEMIX3.0 with UnaBridge", async () => {
            logger.log("Swap AVAX to unaWEMIX with Uni Swap And Bridge WEMIX3.0 with UnaBridge");
